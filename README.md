...
```
bash -c "$(wget -qLO - https://github.com/legacy23/proxmox_hassos_install/raw/master/install_nfs.sh)"   If remote storage
bash -c "$(wget -qLO - https://github.com/legacy23/proxmox_hassos_install/raw/master/install_dir.sh)"   If local storage
```
